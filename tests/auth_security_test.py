...
Methods:
   * test_set_up_password_hashed - Tests that the password stored in the database is correctly hashed.
   * test_set_up_all_password_params - Tests passwords that violate different password requirements.
   * test_password_never_logged_plaintext - Checks that the logger never stores plain text passwords.
