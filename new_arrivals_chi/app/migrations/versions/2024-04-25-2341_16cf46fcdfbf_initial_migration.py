...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['hours_id'], ['hours.id'], ),
    sa.ForeignKeyConstraint(['location_id'], ['locations.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('service_dates',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('date', sa.Date(), nullable=False),
    sa.Column('start_time', sa.Time(), nullable=False),
    sa.Column('end_time', sa.Time(), nullable=False),
    sa.Column('repeat', sa.Enum('every day', 'every week', 'every month', 'every other week', name='repeat_types'), nullable=False),
    sa.Column('service_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['service_id'], ['services.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('languages_organizations',
    ...
    op.create_table('organizations_hours',
    sa.Column('hours_id', sa.Integer(), nullable=False),
    sa.Column('organization_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['hours_id'], ['hours.id'], ),
    sa.ForeignKeyConstraint(['organization_id'], ['organizations.id'], ),
